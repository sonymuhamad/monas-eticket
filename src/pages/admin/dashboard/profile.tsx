...
import {
  AdminPassword,
  AdminProfile,
} from "@/components/components/admin/profile";
...
ProfilePage.getLayout = (profilePage: ReactElement) => {
  return <LayoutAdmin>{profilePage}</LayoutAdmin>;
};
  ...
  async function getServerSideProps({ req, res }) {
    ...
    return {
      props: {
        ...
        emailAdmin: email,
        id: id,
        last_update: updated_at ? updated_at.toString() : null,
      },
    };
  }
);
